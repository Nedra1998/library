        ...
        <form>
          ...
          <div class="form-group row" id="appraisal">
            ...
            <div class="input-group col-sm-10">
              ...
              <input class="form-control currency" type="number" data-number-to-fixed="2" data-number-stepfactor="100" v-model="entry.appraisal" />
            </div>
          </div>
          <button class="btn btn-success btn-lg btn-block" v-on:click="test()" :disabled="isValid() === false">Submit</button>
        </form>
      </div>
      <Footer />
  </div>
